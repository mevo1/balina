...
def runBacktest(backtest, request,strategy,name,strategy_code,coin_list,interval,period,first_margin,commission,moving_tp,moving_sl):
    ...
    last_margin,total_return,process_count,profit_process_count,loss_process_count,success_rate, stock_graph, profit_graph = main(strategy_code,coin_list,interval,period,first_margin,commission,moving_tp,moving_sl)
