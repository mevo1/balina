...
def main(strategy_code,symbols,interval,period,first_margin,commission,moving_tp,moving_sl):
    ...
    last_margin,total_return,process_count,profit_process_count,loss_process_count,success_rate, stock_graph, profit_graph = result(backtest_dict,symbols,first_margin)
    
    #print(profit_graph)
    return result(backtest_dict,symbols,first_margin)
